...
def define_base_shared_sets(model, Period, windfarmNodes=None):
    ...
    Args:
        ...
        Operationalhour: List of operational hours  
        Season: List of seasons
        Scenario: List of scenarios
        GasScenario: List of gas scenarios
        HoursOfSeason: List of (season, hour) tuples
        FirstHoursOfRegSeason: List of first hours of regular seasons
        FirstHoursOfPeakSeason: List of first hours of peak seasons
        offshoreNodesList: List of offshore nodes
        windfarmNodes: List of windfarm nodes (optional)
        industry: Whether industry module is enabled
    """
