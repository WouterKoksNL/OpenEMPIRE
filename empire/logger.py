...
def get_empire_logger(paths: PathsConfig) -> logging.Logger:
    """
    ...
    :param paths: Empire run configuration object containing run details.
    ...
    log_config["handlers"]["file_handler"]["filename"] = paths.results_path / "logs.txt"
