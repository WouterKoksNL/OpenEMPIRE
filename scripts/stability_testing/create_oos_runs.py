...
### CHANGE THIS ###
# You can use the 'OOS'-tab in the file 'Stability_tests_setup.xlsx to define the methods you want to test
...
for i, config in enumerate(settings, start=1):
    ...
    new_content = new_content.replace('method = "copula10"', f'method = "{config["method"]}"')
